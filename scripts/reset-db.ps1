# =============================================================================
# Forum Wędkarskie — resetuje bazę danych do zera
# Używaj gdy migracje są zepsute lub chcesz czystego startu
# =============================================================================

$NAMESPACE = "forum-wedkarskie"

Write-Host "UWAGA: To usunie WSZYSTKIE dane z bazy!" -ForegroundColor Red
$confirm = Read-Host "Czy na pewno chcesz kontynuować? (wpisz 'tak')"
if ($confirm -ne "tak") {
...
Write-Host "  Czekam aż zasoby się zwolnią (5s)..." -ForegroundColor Gray
...
Write-Host "  Czekam na migrację..." -ForegroundColor Gray
