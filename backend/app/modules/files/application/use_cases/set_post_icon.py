...
from app.modules.files.application.commands import FileView, SetPostIconCommand
...
from app.modules.files.domain.events import PostIconChanged
...
class SetPostIconUseCase:
    ...
    async def execute(self, cmd: SetPostIconCommand) -> Result[FileView, DomainError]:
        try:
